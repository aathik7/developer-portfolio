...
export const Icons = {
  code: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M8.7,15.3l-1.4,1.4l-4-4l4-4l1.4,1.4L6.1,12L8.7,15.3z M15.3,8.7l1.4-1.4l4,4l-4,4l-1.4-1.4L17.9,12L15.3,8.7z" />
    </svg>
  ),
  ...
  cloud: (props: React.SVGProps<SVGSVGElement>) => (
     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M19.4,10.1C19,6.6,15.9,4,12,4C9.1,4,6.6,5.6,5.4,8.1C2.3,8.4,0,11,0,14.1C0,17.4,2.7,20,6,20h13.1 c2.7,0,4.9-2.2,4.9-4.9C24,12.4,21.9,10.2,19.4,10.1z" />
    </svg>
  ),
  ...
  rocket: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.05-.64-.75-2.14-1.04-2.95-.95z"/><path d="M14 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/><path d="M19.5 2.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.05-.64-.75-2.14-1.04-2.95-.95z"/><path d="M12.04 12.96L7.07 8 2 21.5l12.5-5.07-2.43-2.47z"/>
    </svg>
  ),
  ...
  logo: (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
      <path d="M12.83,14.03L15.31,9.45L17.75,14.03H12.83M11,7L5,17H19L13,7H11Z" />
    </svg>
  ),
};